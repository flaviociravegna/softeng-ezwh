...
describe('API Test: Item', function () {
    ...
    describe('POST /api/items (errors)', function () {
        ...
        createNewItem(422, { "id": 5, "description": "item no.5", "price": "10", "SKUId": 5, "supplierId": 1 });
        createNewItem(422, { "id": 5, "description": "item no.5", "price": "string", "SKUId": 5, "supplierId": 1 });

        // Illegal skuid(skuid not found in db)
        createNewItem(404, { "id": 5, "description": "item no.5", "price": 10.99, "SKUId": 6, "supplierId": 1 });
        createNewItem(422, { "id": 5, "description": "item no.5", "price": 10.99, "SKUId": "6", "supplierId": 1 });
        createNewItem(422, { "id": 5, "description": "item no.5", "price": 10.99, "SKUId": "string", "supplierId": 1 });
        ...
        createNewItem(422, { "id": 5, "description": "item no.5", "price": 10.99, "SKUId": 1, "supplierId": "string" });
        createNewItem(422, { "id": 5, "description": "item no.5", "price": 10.99, "SKUId": 1, "supplierId": 1 });

        // wrong supplierId
        createNewItem(422, { "id": 1, "description": "item no.1", "price": 10.99, "SKUId": 1, "supplierId": "1" });
        createNewItem(422, { "id": 2, "description": "item no.2", "price": 20.99, "SKUId": 2, "supplierId": -1 });
        createNewItem(422, { "id": 3, "description": "item no.3", "price": 30.99, "SKUId": 3, "supplierId": "string" });
    });
